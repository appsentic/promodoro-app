...
abstract class $SystemErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? message, ErrorType? errorType});
}
...
class _$_SystemError implements _SystemError {
  _$_SystemError({this.message, this.errorType});
  ...
  @override
  String toString() {
    return 'SystemError(message: $message, errorType: $errorType)';
  }
...
abstract class _SystemError implements SystemError {
  factory _SystemError({final String? message, final ErrorType? errorType}) =
      _$_SystemError;
